package lesson4.prg7.employeeinfo;

import java.util.Date;
import java.util.GregorianCalendar;

import lesson4.prg7.MyStringList;
...
public class Employee implements Comparable<Employee> { // implements Comparable<Employee> {
	...
	public int compareTo(Employee e) {
		if (e.accounts.getLargest().getBalance() > accounts.getLargest().getBalance())
			return -1;
		else if (e.accounts.getLargest().getBalance() < accounts.getLargest().getBalance())
			return 1;
